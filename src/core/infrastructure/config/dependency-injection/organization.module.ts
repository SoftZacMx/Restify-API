...
import { RequestOrganizationReactivationUseCase } from '../../../application/use-cases/organization/request-organization-reactivation.use-case';
...
container.register(RequestOrganizationReactivationUseCase, RequestOrganizationReactivationUseCase);
